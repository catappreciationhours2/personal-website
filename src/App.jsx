          ...
          <div className="language-bars">
            <div className="language-entry">
              ...
              <div className="language-bar-track">
                <div className="language-bar-fill python" style={{ width: '95%' }}></div>
              </div>
            </div>
            <div className="language-entry">
              <div className="language-label">Rust – 70%</div>
              <div className="language-bar-track">
                <div className="language-bar-fill rust" style={{ width: '70%' }}></div>
              </div>
            </div>
            <div className="language-entry">
              <div className="language-label">JavaScript – 90%</div>
              <div className="language-bar-track">
                <div className="language-bar-fill js" style={{ width: '90%' }}></div>
              </div>
            </div>
            <div className="language-entry">
              <div className="language-label">C/C++ – 85%</div>
              <div className="language-bar-track">
                <div className="language-bar-fill java" style={{ width: '85%' }}></div>
              </div>
            </div>
            <div className="language-entry">
              <div className="language-label">MATLAB/Simulink – 60%</div>
              <div className="language-bar-track">
                <div className="language-bar-fill matlab" style={{ width: '60%' }}></div>
              </div>
            </div>
          </div>
        </div>
